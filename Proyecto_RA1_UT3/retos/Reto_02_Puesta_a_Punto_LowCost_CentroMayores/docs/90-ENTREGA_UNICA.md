...
- **ROI** = (75,00€ − 58,90€) / 58,90€ = 0,27= 27 %

**Elección final y motivos:** 
Elijo el S2 ya que aumentando un poco el dinero por cada PC se pueden encontrar componentes decentes por segunda mano, haciéndolo mejores por calidad precio respecto otros PCs de segunda mano. Por tanto estamos cobrando menos por algo mejor que ya se puede encontrar en el mercado, haciendo nuestro trabajo más valioso permitiendo subir el ROI. Además, a pesar de los impedimentos y limitaciones por el precio y material, se cumplen los objetivos para el centro de mayores, haciendo ordenadores decentes para las tareas que se requerían.
