...
- **Curso/Grupo:** 1º ASIR, grupo 2 ____  
- **Fecha:** 17/02/2026
...
- Compatibilidad clave 1:  Socket AM4
  - Evidencia (URL): [Geektopia](https://www.geektopia.es/es/product/amd/ryzen-5-3400g/)
   ![AM4](../assets/img/10-pc/cpu_socket.png "Socket AM4 para la CPU")
...
![RAM cpu](../assets/img/10-pc/cpu_ram.png "Velocidad máxima para la CPU")

## PASO 2 — Placa base compatible
**Componente elegido:**  Placa base AM4
- **Marca y modelo:**  Gigabyte A520M K V2
- **Precio (€):**  49,95€
- **URL tienda:**  [📎Coolmod](https://www.coolmod.com/gigabyte-a520m-k-v2-socket-am4/)

**Ficha técnica oficial (obligatorio):**  
- URL oficial (fabricante/estándar):  
- [Gigabyte](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10)
- [PCCom especs](https://www.pccomponentes.com/gigabyte-a520m-k-v2)

**Características principales (resumen):**
- **Socket y Chipset:** Socket AM4 / Chipset AMD A520
- **Formato:** Micro ATX
- **Memoria RAM:** 2 ranuras DDR4 DIMM, Dual Channel, hasta 64 GB y frecuencias hasta 5100 MHz
- **Almacenamiento:** 1 conector M.2 + 4 puertos SATA 6Gb/s
- **Ranuras de Expansión:** 1 x PCI Express 3.0 x16 + 1 x PCI Express 3.0 x1
- **Salidas de Vídeo:** 1 x HDMI 2.1 + 1 x puerto D-Sub
- **Conectividad de Red:** Realtek® GbE LAN (Gigabit Ethernet)
- **Puertos USB (Traseros):** 4 x USB 3.2 Gen 1 + 2 x USB 2.0
- **Audio:** Audio de alta definición (7.1 canales)
...
- El chipset que tiene, es compatible con la 3000G-series aunque puede que se tenga que actualizar la BIOS.

**Compatibilidad (obligatorio, con enlaces):**
- Compatibilidad clave 1: Socket del CPU
  - Evidencia (URL): [Oficial](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10)
![RAM cpu](../assets/img/10-pc/placa_socket.png "Velocidad máxima para la CPU")

- Compatibilidad clave 2: Velocidad máxima de RAM.
  - Evidencia (URL):  [Oficial](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10)
![RAM](../assets/img/10-pc/placa_ram.png "Velocidad de la ram")

- Compatibilidad clave 3: Chipset compatible con la serie.
  - Evidencia (URL):  [Oficial](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10)
![Chipset](../assets/img/10-pc/placa_chipset.png "Chipset compatible")
...
- Las velocidades máximas son mayores que la placa y procesador pueden soportar, entoces hay un poco de cuello de botella, ya que no podemos aprovechar toda la potencia de la RAM. Sin embargo, es mejor eso que adaptar un SO-DIMM a DIMM para ahorrar un poco más. Porque se pierde más velocidad por un mayor cuello de botella.
...
![DDR4](../assets/img/10-pc/ram.png "Tipo de RAM, DDR4")

- Compatibilidad clave 2: Velocidad máxima
  - Evidencia (URL): [PCCom especs](https://www.pccomponentes.com/kingston-valueram-ddr4-3200mhz-4gb-cl22)
![Velocidad](../assets/img/10-pc/ram.png "Velocidad máxima de la CPU")
...
- Compatibilidad clave 1: Puerto SATA en placa base
  - Evidencia (URL): [Gigabyte](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10/sp#sp)
![SATA](../assets/img/10-pc/ssd.png "Puertos SATA en placa")

- Compatibilidad clave 2: Bahía de 2.5" en chasis
  - Evidencia (URL): [Tacens](https://www.tacens.es/cajas/ac4/)
![Bahia](../assets/img/10-pc/ssd_chasis.png "Bahía disco duro")
...
- Compatibilidad clave 1: Formato ATX que encaja en el chasis
 - Evidencia (URL): [Tacens](https://www.tacens.es/cajas/ac4/)
![ATX fuente](../assets/img/10-pc/psu_atx.png "Formato ATX")
 
- Compatibilidad clave 2: Conectores placa y cpi
 - Evidencia (URL): [Tacens](https://www.tacens.es/cajas/ac4/)
![Conectores fuente](../assets/img/10-pc/psu_conectores.png "Conectores ATX y de CPU para la placa")
## PASO 6 — Chasis
...
![Micro ATX chasis](../assets/img/10-pc/chasis_atx.png "Soporte placa base")

- Compatibilidad clave 2: Tamaño libre para el disipador y otros componentes
  - Evidencia (URL): [Tacens especs](https://www.tacens.es/cajas/ac4/)
![Dimensiones](../assets/img/10-pc/chasis_tamaño.png "Dimensiones internas")
...
| Placa base | Gigabyte A520M K V2         | 49,95 €      | [Coolmod](https://www.coolmod.com/gigabyte-a520m-k-v2-socket-am4/)                   |
...
![RAM](../assets/img/20-minipc/minipc_ram.png "Ampliable hasta 64GB")
...
- **¿Se puede ampliar SSD?** Sí, se puede cambiar el NVMe hasta 2TB. Tambien se puede añadir un SSD SATA hasta 1TB o un HDD hasta 2TB.
  - Evidencia: [Geekom especs](https://www.geekom.es/geekom-a5-mini-pc/)
![SSD](../assets/img/20-minipc/minipc_ssd.png "Ampliabilidad para disco")
...
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :-: |
| CPU ↔ Placa base (socket/chipset soportado)        | [AMD](https://www.amd.com/es/products/specifications/processors.html?product-0=AMD+Ryzen%E2%84%A2+5+3400G+with+Radeon%E2%84%A2+RX+Vega+11+Graphics&product-1=) [Gigabyte](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10) |  ✅  |
| RAM ↔ Placa base (DDR4/DDR5, velocidad soportada)  | [PCCom](https://www.pccomponentes.com/kingston-valueram-ddr4-3200mhz-4gb-cl22) [Gigabyte](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10)                                                                                 |  ✅  |
| SSD ↔ Placa base (SATA o M.2; NVMe vs SATA)        | [PCCom](https://www.pccomponentes.com/silicon-power-ace-a55-25-128gb-ssd-ssd-sata-3) [Gigabyte](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10)                                                                           |  ✅  |
| PSU ↔ Placa base (24-pin ATX, EPS 8-pin si aplica) | [MSI](https://es.msi.com/Power-Supply/MAG-A550BN)[Gigabyte](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10)                                                                                                               |  ✅  |
| Chasis ↔ Placa base (ATX/mATX/ITX)                 | [Gigabyte](https://www.gigabyte.com/es/Motherboard/A520M-K-V2-rev-10) [Tacens](https://www.tacens.es/cajas/ac4/)                                                                                                                     |  ✅  |
| Chasis ↔ PSU (ATX/SFX/TFX)                         | [Tacens](https://www.tacens.es/cajas/ac4/) [MSI](https://es.msi.com/Power-Supply/MAG-A550BN)                                                                                                                                         |  ✅  |

## Opción B (Mini PC)
| Punto a verificar                         | Evidencia (enlace)                                 | OK  |
| ----------------------------------------- | -------------------------------------------------- | :-: |
| RAM ampliable (sí/no, máximo)             | [Geekom](https://www.geekom.es/geekom-a5-mini-pc/) |  ✅  |
| SSD ampliable (sí/no, M.2/SATA)           | [Geekom](https://www.geekom.es/geekom-a5-mini-pc/) |  ✅  |
| Conectividad (Wi‑Fi/Ethernet/USB/HDMI/DP) | [Geekom](https://www.geekom.es/geekom-a5-mini-pc/) |  ✅  |

## 5) Conclusión final
- ¿Qué opción elegirías para una oficina real y por qué?
- ¿Qué has aprendido sobre **compatibilidad**?

Erigiría la opción del mini PC ya que es de bastante mejor calidad y tiene un mejor rendimiento y potencia por el precio que tiene. Se ve mucho más bonito y tiene más RAM y almacenamiento, además de que ahorras tiempo en no tener que montarlo y viene con Windows y los drivers instalados.

He aprendido que a un mini PC se le pueden hacer más mejoras de lo que me esperaba, pudiendo añadir no solo más almacenamiento si se queda corto, si no que se puede añadir más RAM y se necesita.
